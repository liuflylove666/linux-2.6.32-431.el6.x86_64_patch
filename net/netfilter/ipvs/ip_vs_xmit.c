 ...
 */
int
ip_vs_normal_response_icmp_xmit(struct sk_buff *skb, struct ip_vs_conn *cp, struct ip_vs_protocol *pp, int offset)
{
...
int
ip_vs_normal_response_icmp_xmit_v6(struct sk_buff *skb, struct ip_vs_conn *cp, struct ip_vs_protocol *pp, int offset)
{
	unsigned int verdict = NF_DROP;
 ...
 */
int
ip_vs_fnat_response_icmp_xmit(struct sk_buff *skb, struct ip_vs_conn *cp, struct ip_vs_protocol *pp, int offset)
{
	struct rtable *rt;	/* Route to the other host */
	int mtu;
	struct iphdr *iph = ip_hdr(skb);
	...
	/* lookup route table */
	if (!(rt = ip_vs_get_rt(skb, &cp->caddr, RT_TOS(iph->tos))))
		goto tx_error_icmp;
...
int
ip_vs_fnat_response_icmp_xmit_v6(struct sk_buff *skb, struct ip_vs_conn *cp, struct ip_vs_protocol *pp, int offset)
{
	struct rt6_info *rt;	/* Route to the other host */
	int mtu;

	/* lookup route table */
	if (!(rt = ip_vs_get_rt_v6(skb, &cp->caddr)))
		goto tx_error_icmp;
 ...
 */
int
ip_vs_normal_response_xmit(struct sk_buff *skb, struct ip_vs_conn *cp, struct ip_vs_protocol *pp, int ihl)
{
	/* copy-on-write the packet before mangling it */
...
int
ip_vs_normal_response_xmit_v6(struct sk_buff *skb, struct ip_vs_conn *cp, struct ip_vs_protocol *pp, int ihl)
{
	/* copy-on-write the packet before mangling it */
	if (!skb_make_writable(skb, ihl))
		goto drop;
 ...
 */
int
ip_vs_fnat_response_xmit(struct sk_buff *skb, struct ip_vs_conn *cp, struct ip_vs_protocol *pp, int ihl)
{
	struct rtable *rt;	/* Route to the other host */
	int mtu;
	struct iphdr *iph = ip_hdr(skb);
...
int
ip_vs_fnat_response_xmit_v6(struct sk_buff *skb, struct ip_vs_conn *cp, struct ip_vs_protocol *pp, int ihl)
{
	struct rt6_info *rt;	/* Route to the other host */
	int mtu;
